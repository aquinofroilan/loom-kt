...
class AssetTransferController(
    ...
    fun transferAsset(
        ...
        @Valid @RequestBody request: AssetTransferRequest,
    ): ResponseEntity<Any> {
        val assetUuid =
            try {
        ...
        val response = assetTransferService.transferAsset(orgId, assetUuid, request, userId)
    ...
    fun listTransfers(
        ...
        val response = assetTransferService.getAssetTransfers(orgId, assetUuid)
